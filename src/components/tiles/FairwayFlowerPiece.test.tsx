...
import FairwayFlowerPiece from './FairwayFlowerPiece'
...
describe('FairwayFlowerPiece', () => {
  it('renders 7 hexes', () => {
    render(<FairwayFlowerPiece origin={{ q: 0, r: 0 }} />)
  ...
  it('applies a custom rotation', () => {
    render(<FairwayFlowerPiece origin={{ q: 0, r: 0 }} rotation={60} />)
