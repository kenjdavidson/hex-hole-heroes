...
import FairwayElbow60Stamp from './FairwayElbow60Stamp'
...
describe('FairwayElbow60Stamp', () => {
  it('renders 55 hexes (convex 60° elbow, armLen=5, width=5)', () => {
    render(<FairwayElbow60Stamp origin={{ q: 0, r: 0 }} />)
  ...
  it('applies a custom rotation for alternate dogleg orientations', () => {
    render(<FairwayElbow60Stamp origin={{ q: 0, r: 0 }} rotation={60} />)
